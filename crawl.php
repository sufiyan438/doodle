...
function createLink($src, $url){
    ...
    $scheme = parse_url($url)["scheme"]; //scheme is http or https
    $host = parse_url($url)["host"]; //host is www.netflix.com
...
function getDetails($url){
    ...
    $titleArray = $parser->gettTitleTags();
...
$startUrl = "https://en.wikipedia.org/wiki/Tom_Cruise";
